...
用於水溶液電導率和水溫檢測的專用晶片，內部集成高精密振盪電路、模數轉換電路和浮點運算單元。 採用專利電導率轉換算灋和溫度校正算灋，快速實現水溶液電導率的檢測，並在較寬的溫度範圍內實現自動溫度校正，降低電導率值隨溫度變化帶來的測量誤差。

LibDriver BA121是LibDriver推出的BA121全功能驅動，該驅動提供電導率讀取和溫度讀取等功能並且它符合MISRA標準。
...
/src目錄包含了LibDriver BA121的源文件。

/interface目錄包含了LibDriver BA121與平台無關的UART總線模板。

/test目錄包含了LibDriver BA121驅動測試程序，該程序可以簡單的測試芯片必要功能。

/example目錄包含了LibDriver BA121編程範例。

/doc目錄包含了LibDriver BA121離線文檔。

/datasheet目錄包含了BA121數據手冊。
...
在線文檔: [https://www.libdriver.com/docs/ba121/index.html](https://www.libdriver.com/docs/ba121/index.html)。
